...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    registerProject: (rootPath, projectPath, projectName, initWithCommit, options) => electron_1.ipcRenderer.invoke('dbgvs:register-project', rootPath, projectPath, projectName, initWithCommit, options),
    ...
    readDbvsIgnore: (workingCopyPath) => electron_1.ipcRenderer.invoke('dbgvs:read-dbvsignore', workingCopyPath),
    writeDbvsIgnore: (workingCopyPath, patterns) => electron_1.ipcRenderer.invoke('dbgvs:write-dbvsignore', workingCopyPath, patterns),
    ...
    generateCommitMessage: (repoPath, workingCopyPath) => electron_1.ipcRenderer.invoke('dbgvs:generate-commit-message', repoPath, workingCopyPath),
    ...
    onProjectProgress: (callback) => {
        electron_1.ipcRenderer.on('project:progress', (_, msg) => callback(msg));
        return () => electron_1.ipcRenderer.removeAllListeners('project:progress');
    },
    // LAN Server
